...
const Index = () => {
  return (
    <div className="min-h-screen py-8 sm:py-16 px-4 bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-screen-xl mx-auto">
        <div className="text-center mb-8 sm:mb-12 animate-slide-down">
          <h1 className="text-3xl md:text-5xl font-bold mb-3 sm:mb-4 tracking-tight bg-gradient-to-r from-blue-700 via-blue-600 to-blue-700 bg-clip-text text-transparent">
            Loan Calculator
          </h1>
        ...
        <div className="mt-8 sm:mt-16 text-center text-xs sm:text-sm text-muted-foreground animate-fade-in">
